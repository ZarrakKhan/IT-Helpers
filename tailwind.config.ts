  ...
  theme: {
    extend: {
      colors: {
        ...
        grey: {
          100: withOpacity("--grey-100"),
          200: withOpacity("--grey-200"),
          300: withOpacity("--grey-300"),
          400: withOpacity("--grey-400"),
          500: withOpacity("--grey-500"),
      ...
      spacing: {
        18: "4.5rem",
        "section-1": "var(--section-space-1)",
        "section-2": "var(--section-space-2)",
        "section-3": "var(--section-space-3)",
        "section-4": "var(--section-space-4)",
      },
      borderRadius: {
        sm: "var(--radius-sm)",
        md: "var(--radius-md)",
